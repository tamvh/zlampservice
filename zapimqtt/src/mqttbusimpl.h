...
#ifndef SYSTEM_MESSAGEBUS_MQTT_MQTTClientImpl_INCLUDED
#define SYSTEM_MESSAGEBUS_MQTT_MQTTClientImpl_INCLUDED
...
class MQTTClientImpl: public iot::messagebus::MQTT::MQTTClient
...
public:
    ...
    int publishMessage(const std::string& topic, const MQTTMessage& message);
...
#endif // SYSTEM_MESSAGEBUS_MQTT_MQTTClientImpl_INCLUDED
